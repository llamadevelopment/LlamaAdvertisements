...
Allow your players to make advertisements
...
3. Start your server.
4. And have fun using LlamaAdvertisements.

---

## Commands & Permissions

Command | Usage | Default Permission (Disabled by default)
------------ | ------------- | -------------
advertise |    /advertise <text> |    llamaadvertisements.advertise
